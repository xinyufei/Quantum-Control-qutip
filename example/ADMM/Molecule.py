...
# name of example
parser.add_argument('--name', help='example name', type=str, default='MoleculeADMM')
# name of molecule
...
output_num = "../output/ADMM/" + "{}_evotime{}_n_ts{}_ptype{}_offset{}_sum_penalty{}_penalty{}_ADMM_{}_iter{}". \
    format(args.name + "_" + args.molecule, args.evo_time, args.n_ts, args.initial_type, args.offset, args.sum_penalty, 
