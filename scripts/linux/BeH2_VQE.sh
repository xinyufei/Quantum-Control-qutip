...
#python Molecule.py --gen_target=1 --name=MoleculeVQE --molecule=BeH2 --qubit_num=6 --evo_time=5 --n_ts=100 --initial_type=CONSTANT --offset=0.5 --sum_penalty=0 --max_iter=10000
#    --target="../control/Continuous/MoleculeVQE_LiH_evotime20.0_n_ts200_target.csv" --max_iter=5000
#python Molecule.py --gen_target=0 --name=MoleculeVQE --molecule=BeH2 --qubit_num=6 --evo_time=5 --n_ts=200 --initial_type=CONSTANT --offset=0.5 --sum_penalty=0.01 \
#    --target="../control/Continuous/MoleculeVQE_BeH2_evotime5.0_n_ts50_target.csv" --max_iter=10000
...
#    --target="../control/Continuous/MoleculeVQE_BeH2_evotime20.0_n_ts200_target.csv" --sum_penalty=0.01 --alpha=1e-3 --rho=3.0 --max_iter_admm=100
...
#python Molecule.py --molecule=BeH2 --qubit_num=6 --evo_time=20 --n_ts=200 \
#    --initial_file="../control/Rounding/MoleculeADMM_BeH2_evotime20.0_n_ts200_ptypeWARM_offset0.5_sum_penalty0.01_penalty0.001_ADMM_3.0_iter100_1_SUR.csv" \
#    --target="../control/Continuous/MoleculeVQE_BeH2_evotime20.0_n_ts200_target.csv" --sos1=1 --alpha=0.001 --tr_type="tv"
#python Molecule.py --molecule=LiH --qubit_num=4 --evo_time=20 --n_ts=200 \
