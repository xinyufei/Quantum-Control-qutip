...
###
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
#    --initial_control="../control/Trustregion/Molecule_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_alpha0.0001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv" \
#    --sos1=0 --t_sos=1 --type=SUR
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
#    --initial_control="../control/Trustregion/Molecule_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_alpha0.0001_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv" \
#    --sos1=0 --t_sos=1 --type="minup" --min_up=10
...
cd ../Trustregion/
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
#    --initial_file="../control/Rounding/Molecule_H2_evotime4.0_n_ts80_ptypeCONSTANT_offset0.5_objUNIT_sum_penalty0.0_SUR.csv" \
#    --sos1=1 --alpha=0.0001 --tr_type="tv"
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
#    --initial_file="../control/Rounding/Molecule_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_SUR.csv" \
#    --sos1=1 --alpha=0.0001 --tr_type="tv"
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
...
#    --sos1=1 --alpha=0.0001 --tr_type="tv"
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
#    --initial_file="../control/Rounding/Molecule_H2_evotime4.0_n_ts80_ptypeWARM_offset0.5_objUNIT_sum_penalty1.0_alpha0.0001_sigma0.25_eta0.001_threshold30_iter100_typetvc_SUR.csv" \
#    --sos1=1 --alpha=0.0001 --tr_type="tv"
#
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=4 --n_ts=80 \
