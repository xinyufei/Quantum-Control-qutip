...
python Molecule.py --name=MoleculeVQEAcc --molecule=H2 --qubit_num=2 --evo_time=20 --n_ts=200 --initial_type=CONSTANT --offset=0 --sum_penalty=1.0 \
    --target="../../hamiltonians/H2_target.csv"
...
cd ../ADMM/
#python Molecule.py --name=MoleculeADMMVQENew --molecule=H2 --qubit_num=2 --evo_time=10 --n_ts=100 --initial_type=WARM \
...
#    --target="../../hamiltonians/H2_target.csv" --sum_penalty=1.0 --alpha=1e-3 --rho=0.5 --max_iter_admm=100
...
#python Molecule.py --molecule=H2 --qubit_num=2 --evo_time=10 --n_ts=100 \
#    --initial_file="../control/Continuous/MoleculeVQENew_H2_evotime10.0_n_ts100_ptypeCONSTANT_offset0.5_objUNIT_sum_penalty1.0.csv" \
#    --target="../../hamiltonians/H2_target.csv" --sos=1 --alpha=0.001 --tr_type="tvc"
