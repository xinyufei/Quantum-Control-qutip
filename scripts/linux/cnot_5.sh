...
python CNOT.py --name=CNOTSQ --evo_time=5 --n_ts=100 --initial_type=CONSTANT --offset=0.5
cd ../ADMM/
#python CNOT.py --name=CNOTSUADMM --evo_time=5 --n_ts=100 --initial_type=WARM \
#    --initial_control="../control/Continuous/CNOTSU_evotime5.0_n_ts100_ptypeCONSTANT_offset0.5_objUNIT.csv" \
#    --alpha=0.0001 --rho=0.25 --max_iter_admm=100
#python CNOT.py --name=CNOTSUADMM --evo_time=5 --n_ts=100 --initial_type=WARM \
#    --initial_control="../control/ADMM/CNOTSUADMM_evotime5.0_n_ts100_ptypeWARM_offset0.5_objUNIT_penalty1e-06_ADMM_0.25_iter100.csv" \
#    --alpha=1e-5 --rho=0.25 --max_iter_admm=100
#python CNOT.py --name=CNOTSUADMM --evo_time=5 --n_ts=100 --initial_type=WARM \
#    --initial_control="../control/ADMM/CNOTSUADMM_evotime5.0_n_ts100_ptypeWARM_offset0.5_objUNIT_penalty1e-05_ADMM_0.25_iter100.csv" \
#    --alpha=1e-4 --rho=0.25 --max_iter_admm=100
#python CNOT.py --name=CNOTSUADMM --evo_time=5 --n_ts=100 --initial_type=WARM \
#    --initial_control="../control/ADMM/CNOTSUADMM_evotime5.0_n_ts100_ptypeWARM_offset0.5_objUNIT_penalty0.0001_ADMM_0.25_iter100.csv" \
...
#python CNOT.py --name=CNOTSUADMM --evo_time=5 --n_ts=100 --initial_type=WARM \
#    --initial_control="../control/ADMM/CNOTSUADMM_evotime5.0_n_ts100_ptypeWARM_offset0.5_objUNIT_penalty0.01_ADMM_0.25_iter100.csv" \
...
#
#python CNOT.py --evo_time=5 --n_ts=100 \
#    --initial_control="../control/Trustregion/CNOTSU_evotime5.0_n_ts100_ptypeCONSTANT_offset0.5_objUNIT_alpha0.01_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv" \
#    --sos1=0 --type=SUR
#python CNOT.py --evo_time=5 --n_ts=100 \
#    --initial_control="../control/Trustregion/CNOTSU_evotime5.0_n_ts100_ptypeCONSTANT_offset0.5_objUNIT_alpha0.01_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv" \
#    --sos1=0 --type="minup" --min_up=10
...
cd ../Trustregion/
#python CNOT.py --evo_time=5 --n_ts=100 \
#    --initial_file="../control/Rounding/CNOTSU_evotime5.0_n_ts100_ptypeCONSTANT_offset0.5_objUNIT_SUR.csv" \
#    --alpha=0.01 --tr_type="tv"
#python CNOT.py --evo_time=5 --n_ts=100 \
#    --initial_file="../control/Rounding/CNOTSUADMM_evotime5.0_n_ts100_ptypeWARM_offset0.5_objUNIT_penalty0.01_ADMM_0.25_iter100_SUR.csv" \
#    --alpha=0.01 --tr_type="tv"
#python CNOT.py --evo_time=5 --n_ts=100 \
