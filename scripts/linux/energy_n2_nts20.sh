...
cd ../SwitchingTime/
#python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 --admm_control="../control/ADMM/EnergyADMM2_evotime1.0_n_ts40_ptypeWARM_offset0.5_penalty0.1_ADMM_10.0_iter100.csv" \
#    --min_up_time=0 --alpha=0.1
#python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 --admm_control="../control/ADMM/EnergyADMM2_evotime2.0_n_ts40_ptypeWARM_offset0.5_penalty0.01_ADMM_10.0_iter100.csv" \
#    --min_up_time=0.5 --alpha=0.01
#python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 --admm_control="../control/Trustregion/Energy2_evotime2.0_n_ts40_ptypeCONSTANT_offset0.5_sigma0.25_eta0.001_threshold30_iter100_typetvc.csv" \
