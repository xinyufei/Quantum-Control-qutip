...
python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 \
    --initial_file="../control/Rounding/Energy2_evotime1.0_n_ts20_ptypeCONSTANT_offset0.5_alpha0.1_sigma0.25_eta0.001_threshold30_iter100_typetvc_SUR.csv" \
    --alpha=0.1 --tr_type="tv"
python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 \
    --initial_file="../control/Rounding/Energy2_evotime1.0_n_ts20_ptypeCONSTANT_offset0.5_alpha0.1_sigma0.25_eta0.001_threshold30_iter100_typetvc_minup10.csv" \
    --alpha=0.1 --tr_type="hard" --hard_type="minup" --min_up=10
python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 \
    --initial_file="../control/Rounding/Energy2_evotime1.0_n_ts20_ptypeCONSTANT_offset0.5_alpha0.1_sigma0.25_eta0.001_threshold30_iter100_typetvc_maxswitch5.csv" \
    --alpha=0.1 --tr_type="hard" --hard_type="maxswitch" --max_switch=5
#python energy.py --n=2 --num_edges=1 --evo_time=1 --n_ts=20 \
