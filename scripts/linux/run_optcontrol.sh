#!/user/bin/env bash
cd "/Volumes/GoogleDrive/My Drive/PhD-topic/Quantum-Computing/code/Quantum-Control-qutip/example/Continuous/"
...
python Hadamard.py --qubit_num=2 --evo_time=8 --n_ts=80 --initial_type='CONSTANT' --offset=0.5 >> "../output/Hadamard2_8_80_CONSTANT_0.5.log"
cd ../scripts